...
@RestController
@BosApi
@Api(value = "角色接口", description = "用户权限管理-角色接口")
@RequestMapping("/api/v1/upms_role")
public class UpmsRoleApi extends BaseApi<UpmsRole>{
    @Override
    public BaseService service() {
        return BaseProvider.getBean(UpmsRoleService.class);
    }
    ...
    @Override
    public Map update(@RequestBody UpmsRole model){
